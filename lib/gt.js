...
var g_shapeFile = "./i18n/" + g_appSettings.locale + "-shapes.json";
...
g_mapImageArray[1] = "./img/online_map.png";
g_mapImageArray[0] = "./img/offline_map.png";
...
if (g_appSettings.locale === "cnt")
{
g_gridViewArray[1] = "實時";
g_gridViewArray[2] = "日誌";
g_gridViewArray[3] = "日誌 &amp; 實時";
}
if (g_appSettings.locale === "cn")
{
g_gridViewArray[1] = "实时";
g_gridViewArray[2] = "日志";
...
if (g_appSettings.locale === "cnt")
{
g_viewInfo[0] = ["g_qsoGrids", "網格" , 0, 0, 0];
g_viewInfo[1] = ["g_cqZones", "CQ分區" , 0, 0, 40];
g_viewInfo[2] = ["g_ituZones", "ITU分區" , 0, 0, 90];
g_viewInfo[3] = ["g_wacZones", "各大洲" , 0, 0, 7];
g_viewInfo[4] = ["g_wasZones", "美國各州" , 0, 0, 50];
g_viewInfo[5] = ["g_dxccInfo", "DXCCs" , 0, 0, 340];
g_viewInfo[6] = ["g_countyData", "美國各縣" , 0, 0, 3220];
g_viewInfo[7] = ["g_us48Data", "美國大陸48網格" , 0, 0, 488];
}
...
function ignoreMessagesToggle()
{
  ...
  if (g_ignoreMessages == 0)
  {
    ...
    txrxdec.innerHTML = $.i18n("gt.txrxdec.innerHTML1");
    txrxdec.title = $.i18n("gt.txrxdec.title1");
  }
  else
  {
    txrxdec.style.backgroundColor = "DimGray";
    txrxdec.style.borderColor = "DarkGray";
    txrxdec.innerHTML = $.i18n("gt.txrxdec.innerHTML2");
    txrxdec.title = $.i18n("gt.txrxdec.title2");
  }
}
...
function createTooltTipTable(toolElement)
{
  ...
  if (toolElement.qso == true)
  {
    ...
    {
      worker +=
        "<tr align='center'><td>"+$.i18n("gt.spotTable.Call")+"</td><td>"+$.i18n("gt.spotTable.Freq")+"</td><td>"+$.i18n("gt.newCallList.Sent")+"</td><td>"+$.i18n("gt.newCallList.Rcvd")+"</td><td>"+$.i18n("gt.newCallList.Call")+"</td><td>"+$.i18n("gt.spotTable.Mode")+"</td><td>"+$.i18n("gt.spotTable.Band")+"</td><td>"+$.i18n("gt.newCallList.QSL")+"</td><td>"+$.i18n("gt.newCallList.LastMsg")+"</td><td>DXCC</td><td>"+$.i18n("gt.newCallList.Time")+"</td>";
...
function makeTitleInfo(mapWindow)
{
  ...
  var space = " ";
  var news = ` `+$.i18n("gt.TitleInfo.GridTracker")+` ${gtVersionStr}  [ `+$.i18n("gt.TitleInfo.Band")+` ${band}  `+$.i18n("gt.TitleInfo.Mode")+` ${mode}`;
  var end = " ]";

  if (mapWindow)
  {
    news += `  `+$.i18n("gt.TitleInfo.maplayer")+` ${g_viewInfo[g_currentOverlay][1]}`;
  }
...
function moonOver(feature)
{
  ...
  worker +=
    "<tr><th colspan=2 style='font-size:15px;color:cyan;'>"+$.i18n("gt.moonOver.Moon")+"</th></tr>";
  worker +=
    "<tr><th >"+$.i18n("gt.moonOver.Azimuth")+"</th><td  style='color:lightgreen'>" +
    object.azimuth.toFixed(1) +
    "&deg;</td></tr>";
  worker +=
    "<tr><th >"+$.i18n("gt.gridTable.Dist")+"</th><td  style='color:" +
    elColor +
    "'>" +
    elevation +
    "</td></tr>";
...
function trophyOver(feature)
{
  ...
  if (infoObject.worked)
  {
    ...
    wc1Table +=
      "<tr><td colspan=2 ><font  color='yellow'>"+$.i18n("gt.TitleInfo.Worked")+"</font></td></tr>";
    wc1Table += "<tr><td align=right><font color='green'>"+$.i18n("gt.TitleInfo.Band")+"</font></td>";
    ...
    wc1Table += "</tr>";
    wc1Table += "<tr>";
    wc1Table += "<td align=right><font color='orange'>"+$.i18n("gt.TitleInfo.Mode")+"</font></td>";
    wc1Table += "<td align=left><table class='subtable'>";
  ...
  if (infoObject.confirmed)
  {
    ...
    wcTable +=
      "<tr><td colspan=2 ><font  color='lightgreen'>"+$.i18n("gt.TitleInfo.Confirmed")+"</font></td></tr>";
    wcTable += "<tr><td align=right><font color='green'>"+$.i18n("gt.TitleInfo.Band")+"</font></td>";
    ...
    wcTable += "</tr>";
    wcTable += "<tr>";
    wcTable += "<td align=right><font color='orange'>"+$.i18n("gt.TitleInfo.Mode")+"</font></td>";
    wcTable += "<td align=left><table class='subtable'>";
  ...
  {
    worker +=
      "<tr><td colspan=2 ><font  color='orange'>"+$.i18n("gt.TitleInfo.Needed")+"</font></td></tr>";
  }
  else
  {
...
function mouseDownGrid(longlat, event)
{
  ...
  worker +=
    "<tr><td>"+$.i18n("gt.gridTable.Dist")+"</td><td style='color:lightgreen'>" +
    parseInt(
      MyCircle.distance(
        g_myLat,
        g_myLon,
    ...
    "</td></tr>";
  worker +=
    "<tr><td>"+$.i18n("gt.gridTable.Azim")+"</td><td style='color:yellow'>" + bearing + "&deg;</td></tr>";
  worker +=
    "<tr><td>"+$.i18n("gt.gridTable.Lat")+"</td><td style='color:orange'>" +
    longlat[1].toFixed(3) +
    "</td></tr>";
  worker +=
    "<tr><td>"+$.i18n("gt.gridTable.Long")+"</td><td style='color:lightblue'>" +
    longlat[0].toFixed(3) +
    "</td></tr></table>";
...
function toggleStrikesValue()
{
  if (g_mapSettings.strikesNotify == false && g_mapSettings.strikes == false)
  {
    var confirmed = window.confirm(
      $.i18n("gt.LighteningStrike.disclaimer")
    );
    if (confirmed == false)
    {
      return;
...
function updateCountStats()
{
  ...
  {
    clearOrLoadButton.innerHTML = $.i18n("gt.UpdateCount.ClearLog");
    g_loadQSOs = false;
  }
  else
  {
    clearOrLoadButton.innerHTML = $.i18n("gt.UpdateCount.LoadLog");
    g_loadQSOs = true;
  }
}
...
function getCurrentBandModeHTML()
{
  ...
  return (
    "<div style='vertical-align:top;display:inline-block;margin-bottom:3px;color:lightgreen;font-weight:bold;font-size:larger'>"+$.i18n("mapFilter.mode.currentdisplay") +" <text style='color:yellow'>" +
    $.i18n("gt.TitleInfo.Band") + band + 
    "</text> / <text style='color:orange'> " +
    $.i18n("gt.TitleInfo.Mode") + mode +
    "</text></b></div><br/>"
  );
}
...
function displayTime()
{
  ...
  else secondsAgoMsg.innerHTML = "<b>"+$.i18n("gt.currentTime.never");+"</b>";
...
function toggleStrikeGlobal()
{
  ...
  if (g_mapSettings.strikes == false) { worker += "<br/><font color='red'>"+$.i18n("gt.LighteningStrike.Disabled");+"</font>"; }
...
function handleStrike(strike)
{
  ...
  if (inRange == true)
  {
    ...
    var worker =
          "<font style='color:yellow;font-weight:bold'>"+$.i18n("gt.LighteningStrike.Detected");+"</font><br/>";
    worker +=
      "<font style='color:white'>" + userTimeString(null) + "</font><br/>";
    worker +=
          "<font style='color:orange'>"+$.i18n("gt.LighteningStrike.Distance");+"</font><font style='color:lightblue;font-weight:bold'>" +
      dist +
      "</font><br/>";
    worker +=
          "<font style='color:cyan'>"+$.i18n("gt.LighteningStrike.Bearing");+"</font><font style='color:lightgreen;font-weight:bold'>" +
      azim +
      "</font>";
...
function setCallAndGrid(callsign, grid, instance = null, genMessages = true)
{
  ...
  if (instance != null)
  {
    ...
    {
      alert( $.i18n("gt.WSJTMessage.error") );
    }
  }
  else
  {
  ...
  if (thisInstance && (thisInstance.TxEnabled == 0 || genMessages == false))
  {
    ...
    if (genMessages == true)
    {
      ...
      responseArray = responseArray.slice(0, length);
      wsjtUdpMessage(responseArray, responseArray.length, port, address);
      addLastTraffic("<font color='lightgreen'>"+$.i18n("gt.WSJTMessage.Generated")+"</font>");
    }
    else
    {
      // Callsign
  ...
  {
    addLastTraffic("<font color='yellow'>"+$.i18n("gt.WSJTMessage.TransmitEnable")+"</font><br/><font color='yellow'>"+$.i18n("gt.WSJTMessage.Generateddisable")+"</font>");
  }
}
...
function handleWsjtxStatus(newMessage)
{
  ...
  if (g_activeInstance == newMessage.instance)
  {
    ...
    if (newMessage.Decoding == 1)
    {
      ...
      txrxdec.innerHTML = $.i18n("roster.process.Decode");
      g_countIndex++;
    ...
    else
    {
      ...
      if (g_countIndex != g_lastCountIndex)
      {
        ...
        worker += "<tr><th colspan=7>"+$.i18n("gt.WSJTMessage.Last") + g_lastMessages.length + $.i18n("gt.WSJTMessage.DecodedMsg");+"</th></tr>";
        worker += "<tr><th>"+$.i18n("gt.WSJTMessage.Time") +"</th><th>"+$.i18n("gt.WSJTMessage.dB") +"</th><th>"+$.i18n("gt.WSJTMessage.DT") +"</th><th>"+$.i18n("gt.WSJTMessage.Freq") +"</th><th>"+$.i18n("gt.WSJTMessage.Mode") +"</th><th>"+$.i18n("gt.WSJTMessage.Message") +"</th><th>DXCC</th></tr>";
      ...
      txrxdec.style.backgroundColor = "Green";
      txrxdec.style.borderColor = "GreenYellow";
      txrxdec.innerHTML = $.i18n("gt.WSJTMessage.Receive");
    }
    ...
    else
    {
      ...
      txrxdec.innerHTML = $.i18n("gt.WSJTMessage.Transmit");
      g_layerSources.transmit.clear();
      g_transmitFlightPath = null;
    ...
    else
    {
      if (typeof data.appSettings == "undefined")
      {
        importSettingsFile.innerHTML =
          "<font style='color:red'>"+$.i18n("gt.importSettings.Corrupt") +"</font>";
      }
      else if (data.currentVersion != localStorage.currentVersion)
      {
        importSettingsFile.innerHTML =
          "<font style='color:red'>"+$.i18n("gt.importSettings.Mismatch") +"</font>";
      }
    }
  }
}
...
function showCallsignBox(redraw)
{
  ...
  if (g_newCallsignCount > 0)
  {
    ...
    worker +=
      ...
      "px;'><table class='darkTable' align=center><th align=left>"+$.i18n("gt.callsignBox.callsign") +"</th><th align=left>"+$.i18n("gt.callsignBox.Grid") +"</th><th>DXCC</th><th>CQ</th><th>ITU</th><th>"+$.i18n("gt.callsignBox.Flag") +"</th><th align=left>"+$.i18n("gt.callsignBox.QSO") +"</th><th>"+$.i18n("gt.callsignBox.QSL") +"</th><th>"+$.i18n("gt.WSJTMessage.Time") +"</th>"; // <th>ITUz</th><th>CQz</th><th>ISO</th>";
  ...
  if (Object.keys(g_dxccCount).length > 0)
  {
    ...
    worker +=
      ...
      heard +
      ")</th><tr><th align=left>"+$.i18n("gt.callsignBox.Name") +"</th><th>Flag</th><th align=left>"+$.i18n("gt.callsignBox.Calls") +"</th></tr>";
    Object.keys(List)
      .sort()
...
function showWorkedBox(sortIndex, nextPage, redraw)
{
  try
  {
    ...
    var workHead = "<b> "+$.i18n("gt.logbook.list1") +" (" + ObjectCount + " </b>"+$.i18n("gt.logbook.list2");
    ...
    if (g_qsoPages > 1)
    {
      workHead +=
        ...
        mySort +
        ", -1);'>"+$.i18n("gt.logbook.pre") +" &#8678;&nbsp;</font>";
      workHead +=
        $.i18n("gt.logbook.no1") +
        (g_qsoPage + 1) +
        $.i18n("gt.logbook.no2") +
        g_qsoPages +
        $.i18n("gt.logbook.page") +
        (endIndex - startIndex) +
        $.i18n("gt.logbook.list2");
      workHead +=
        "<font  style='font-size:16px;' color='cyan' onClick='window.opener.showWorkedBox(" +
        mySort +
        ", 1);'>&nbsp;&#8680; "+$.i18n("gt.logbook.next")+"</font>";
    }
    ...
    if (myObjects != null)
    {
      ...
      worker += "</tr> ";
      worker += "<tr><th style='cursor:pointer;' align=center onclick='window.opener.showWorkedBox(0);'>"+ $.i18n("gt.logbook.callsign") + "</th>";
      worker += "<th style='cursor:pointer;' align=center onclick='window.opener.showWorkedBox(1);'>"+ $.i18n("gt.spotTable.Grid") + "</th>";
      worker += "<th style='cursor:pointer;' align=center onclick='window.opener.showWorkedBox(5);'>"+ $.i18n("gt.spotTable.Band") + "</th>";
      worker += "<th style='cursor:pointer;' align=center onclick='window.opener.showWorkedBox(2);'>"+ $.i18n("gt.spotTable.Mode") + "</th>";
      worker += "<th style='cursor:pointer;' align=center onclick='window.opener.showWorkedBox(6);'>"+ $.i18n("gt.newCallList.QSL") + "</th>";
      worker += "<th align=center>"+ $.i18n("gt.newCallList.Sent") + "</th>";
      worker += "<th align=center>"+ $.i18n("gt.newCallList.Rcvd") + "</th>";
      ...
      worker += "<th style='cursor:pointer;' align=center onclick='window.opener.showWorkedBox(4);'>"+ $.i18n("gt.newCallList.Time") + "</th>";
      if (g_callsignLookups.lotwUseEnable == true) worker += "<th>LoTW</th>";
      if (g_callsignLookups.eqslUseEnable == true) worker += "<th>eQSL</th>";
      if (g_callsignLookups.oqrsUseEnable == true) worker += "<th>OQRS</th>";
      worker += "</tr>";
...
function showDXCCsBox()
{
  ...
  if (worked > 0)
  {
    worker +=
      ...
      "px;'><table class='darkTable' align=center><tr><th colspan=5 style='font-weight:bold'>"+ $.i18n("gt.dxccBox.Worked") + " (" +
      worked +
      ")</th><tr><th align=left>"+ $.i18n("gt.callsignBox.Name") + "</th><th>"+ $.i18n("gt.qsoPage.Flag") + "</th><th align=left>DXCC</th></tr>";
    Object.keys(List)
      .sort()
      .forEach(function (key, i)
      {
  ...
  if (confirmed > 0)
  {
    worker +=
      ...
      "px;'><table class='darkTable' align=center><tr><th colspan=5 style='font-weight:bold'>"+ $.i18n("gt.dxccBox.Confirmed") + " (" +
      confirmed +
      ")</th><tr><th align=left>"+ $.i18n("gt.callsignBox.Name") + "</th><th>"+ $.i18n("gt.qsoPage.Flag") + "</th><th align=left>DXCC</th></tr>";
  ...
  if (needed > 0)
  {
    worker +=
      ...
      "px;'><table class='darkTable' align=center><tr><th colspan=3 style='font-weight:bold'>"+ $.i18n("gt.dxccBox.Needed") + " (" +
      needed +
      ")</th><tr><th align=left>"+ $.i18n("gt.callsignBox.Name") + "</th><th>"+ $.i18n("gt.qsoPage.Flag") + "</th><th align=left>DXCC</th></tr>";
...
function showCQzoneBox()
{
  ...
  worker +=
    "<div style='vertical-align:top;display:inline-block;margin-right:8px;overflow:auto;overflow-x:hidden;color:cyan;'><b>"+$.i18n("gt.dxccBox.Worked")+" "+$.i18n("gt.awardNames.CQ")+"</b><br/>";
...
function showITUzoneBox()
{
  ...
  worker +=
    "<div style='vertical-align:top;display:inline-block;margin-right:8px;overflow:auto;overflow-x:hidden;color:cyan;'><b>"+$.i18n("gt.dxccBox.Worked")+" "+$.i18n("gt.awardNames.ITU")+"</b><br/>";
...
function showWASWACzoneBox()
{
  ...
  worker +=
    "<div style='vertical-align:top;display:inline-block;margin-right:8px;overflow:auto;overflow-x:hidden;color:cyan;'><b>"+$.i18n("gt.dxccBox.Worked")+" "+$.i18n("gt.awardNames.WAC")+"</b><br/>";
  worker += displayItemList(g_wacZones, "#90EE90");
  worker += "</div>";

  worker +=
    "<div style='vertical-align:top;display:inline-block;margin-right:8px;overflow:auto;overflow-x:hidden;color:cyan;'><b>"+$.i18n("gt.dxccBox.Worked")+" "+$.i18n("gt.awardNames.WAS")+"</b><br/>";
...
function displayItemList(table, color)
{
  ...
  worker += "<table class='darkTable' align=center>";
  worker +=
    "<tr><th style='font-weight:bold'>"+ $.i18n("gt.dxccBox.Worked") + " (" + worked + ")</th></tr>";
  worker +=
    "<tr><th style='font-weight:bold'>"+ $.i18n("gt.dxccBox.Confirmed") + " (" + confirmed + ")</th></tr>";
  worker +=
    "<tr><th style='font-weight:bold'>"+ $.i18n("gt.dxccBox.Needed") + " (" + needed + ")</th></tr>";
  worker += "<tr><th align=left>"+ $.i18n("gt.dxccBox.Name") + "</th></tr>";
...
function showWPXBox()
{
  ...
  {
    worker +=
      "<div  style='vertical-align:top;display:inline-block;margin-right:8px;overflow:auto;overflow-x:hidden;color:cyan;'><b>"+$.i18n("gt.dxccBox.Worked")+" "+$.i18n("gt.awardNames.WPX")+" (<font color='#fff'>" +
      worked +
      "</font>)</b><br/>";
    worker +=
      "<div  style='color:white;vertical-align:top;display:inline-block;margin-right:8px;overflow:auto;overflow-x:hidden;height:" +
  ...
  {
    worker +=
      "<div  style='vertical-align:top;display:inline-block;margin-right:8px;overflow:auto;overflow-x:hidden;color:cyan;'><b>"+$.i18n("gt.WPXBox.confirmed")+" (<font color='#fff'>" +
      confirmed +
      "</font>)</b><br/>";
    worker +=
      "<div  style='color:white;vertical-align:top;display:inline-block;margin-right:8px;overflow:auto;overflow-x:hidden;height:" +
...
function renderStatsBox()
{
  ...
  try
  {
    ...
    worker +=
      "<tr><td>"+ $.i18n("gt.logbook.callsign")  +
      ws +
    ...
    worker +=
      "<table style='display:inline-table;margin:5px;' class='darkTable'>";
    worker +=
      "<tr><th>" + $.i18n("gt.logbook.topScore") +"</th><th style='color:yellow'>" + $.i18n("gt.logbook.worked") +"</th><th style='color:lightgreen'>" + $.i18n("gt.logbook.confirmed") +"</th></tr>";
    ...
    scoreSection = $.i18n("gt.Distances");
...
function createDistanceTable(obj, name)
{
  ...
  worker +=
    ...
    "</th></tr>";
  worker +=
    "<tr><td></td><td><font  color='yellow'>"+$.i18n("gt.distanceTable.Worked")+"</font></td><td colspan=2 ><font color='lightgreen'>"+$.i18n("gt.stationsTable.QSL")+"</font></td></tr>";
  worker += "<tr><td align=center><font color='lightgreen'>"+$.i18n("gt.stationsTable.Band")+"</font></td>";
  ...
  worker += "</table></td>";
  worker += "</tr>";
  worker += "<tr><td align=center><font color='orange'>"+$.i18n("gt.stationsTable.Mode")+"</font></td>";
  worker += "<td align=left><table class='subtable'>";
...
function renderBandActivity()
{
  ...
  {
    buffer = $.i18n("gt.bandActivity.NoData") ;
  }
...
function ValidateCallsign(inputText, validDiv)
{
  ...
  if (inputText.value.length > 0)
  {
    ...
    if (passed)
    {
      inputText.style.color = "#FF0";
      inputText.style.backgroundColor = "green";
      if (validDiv) validDiv.innerHTML = $.i18n("gt.validate.Valid");
      return true;
    }
    else
    {
      inputText.style.color = "#000";
      inputText.style.backgroundColor = "yellow";
      if (validDiv) validDiv.innerHTML = $.i18n("gt.validate.Invalid");
      return false;
    }
  }
  else
...
function loadMaidenHeadData()
{
  ...
  if (fs.existsSync(file))
  {
    ...
    g_StateData = JSON.parse(fs.readFileSync("./data/" + g_appSettings.locale + "-state.json"));
    ...
    fileBuf = fs.readFileSync("./i18n/" + g_appSettings.locale + "-cqzone.json");
    ...
    if (versionArray.length == 3)
    {
      ...
      if (gtVersion < stableVersion)
      {
        ...
        newVersionMustDownloadDiv.innerHTML =
          $.i18n("gt.NewVersion.Release") +
          verString.substr(0, 1) +
          "." +
          verString.substr(1, 2) +
          "." +
          verString.substr(3) +
          " "+ $.i18n("gt.newVersion.Text2") +"<br /><br />";
...
function timedGetVoices()
{
  ...
  if (g_voices.length > 0)
  {
    ...
    newSelect.title = $.i18n("gt.GetVoices.title");
...
function gotAudioDevices(deviceInfos)
{
  ...
  newSelect.title = $.i18n("gt.GetAudioDev.title");
...
function loadViewSettings()
{
  ...
  spotHistoryTimeTd.innerHTML =
    $.i18n("gt.spots.maxAge") + Number(g_receptionSettings.viewHistoryTimeSec).toDHM();
...
function postInit()
{
  ...
  addLastTraffic( $.i18n("gt.addLastTraffic") + "</br>" + gtShortVersion);
...
var g_startupTable = [
  ...
  [gtChatSystemInit, "聊天系统已初始化"],
  [initPota, "POTA 已初始化"],
  [downloadAcknowledgements, "已加载捐献者致谢"],
  [postInit, "系统已敲定"] 
  ];
}
...
{
var g_startupTable = [
  [startupVersionInit, "版本檢查已完成"],
  [loadi18n, "加載語言完成"],
  [qsoBackupFileInit, "通聯備份已初始化"],
  [callsignServicesInit, "呼號服務已初始化"],
  [loadMapSettings, "地圖設定已初始化"],
  [initMap, "載入地圖"],
  [setPins, "創造別針"],
  [loadViewSettings, "載入視圖設定"],
  [loadMsgSettings, "載入信息設定"],
  [setFileSelectors, "設定檔案選擇"],
  [lockNewWindows, "載入新窗口"],
  [loadMaidenHeadData, "載入 Maidenhead 數据集"],
  [drawAllGrids, "渲染所有 Maidenhead 網格"],
  [updateRunningProcesses, "更新正在運行的進程"],
  [updateBasedOnIni, "更新自 WSJT-X/JTDX"],
  [loadAdifSettings, "載入 ADIF 設定"],
  [startupButtonsAndInputs, "按鈕和輸入已初始化"],
  [initSpeech, "語音已初始化"],
  [initSoundCards, "聲音已初始化"],
  [loadPortSettings, "載入網絡設定"],
  [loadLookupDetails, "呼號查找詳細資訊已載入"],
  [renderLocale, "呈現區域設置"],
  [startupEventsAndTimers, "設定事件和計時器"],
  [registerHotKeys, "注册熱鍵"],
  [gtChatSystemInit, "對話系統已初始化"],
  [initPota, "載入 POTA 資料庫"],
  [downloadAcknowledgements, "貢獻者致谢已載入"],
  [postInit, "系統已完成"]
  ];
}
...
function init()
{
  ...
  else
  {
    ...
    startupStatusDiv.innerHTML = $.i18n("gt.init.starting");
...
function startupEngine()
{
  ...
  {
    startupStatusDiv.innerHTML = $.i18n("gt.startupEngine.completed");
...
function continueWithLookup(callsign, gridPass)
{
  setLookupDiv(
    "lookupInfoDiv",
    $.i18n("gt.lookup.lookingUp1")+" <font color='cyan'>" + callsign + "</font>, "+ $.i18n("gt.lookup.lookingUp2")
  );
  ...
  else
  {
    ...
    {
      var worker =
        "<center>"+$.i18n("gt.callookDX1")+"<br/>";
      worker +=
        "<br/>"+$.i18n("gt.callookDX2")+" <font color='orange'>" +
        callsign +
        "</font> "+$.i18n("gt.callookDX3")+" <font color='yellow'>" +
        where +
        "</font><br/>";
      worker +=
        "<br/><br/>"+$.i18n("gt.callookDX4")+"<br/>";
      worker +=
        $.i18n("gt.callookDX5")+"<br/></center>";
...
function callookResults(buffer, gridPass)
{
  ...
  if (typeof results.status != "undefined")
  {
    if (results.status == "VALID")
    {
      ...
      callObject.source =
        "<tr><td>"+$.i18n("gt.lookup.Source")+"</td><td><font color='orange'><b><div style='cursor:pointer' onClick='window.opener.openSite(\"https://callook.info/" +
...
{
  if (g_mapSettings.offlineMode == true) return;
  if (resultTd != null) resultTd.innerHTML = $.i18n("adif.TestResult.testing");
...
function hamQthGetSessionCallback(buffer, resultTd)
{
  ...
  if (oDOM != null)
  {
    ...
    {
      result = "<font color='red'>"+$.i18n("gt.QRZhamQTH.invalid")+"</font>";
      g_qrzLookupSessionId = null;
    }
  }
  else
  {
    result = "<font color='red'>"+$.i18n("gt.QRZhamQTH.error")+"</font>";
    g_qrzLookupSessionId = null;
  }
  if (resultTd == null)
  {
...
function qrzGetSessionCallback(buffer, resultTd, useCache)
{
  ...
  if (oDOM != null)
  {
    ...
    if (json.hasOwnProperty("Session"))
    {
      ...
      {
        result = "<font color='green'>"+$.i18n("gt.QRZhamQTH.valid")+"</font>";
...
function qthHamLookupResults(buffer, gridPass, useCache)
{
  ...
  if (oDOM != null)
  {
    ...
    if (json.hasOwnProperty("search"))
    {
      ...
      json.search.source =
        "<tr><td>"+$.i18n("gt.lookup.Source")+"</td><td><font color='orange'><b><div style='cursor:pointer' onClick='window.opener.openSite(\"https://www.hamqth.com/" +
...
function qrzLookupResults(buffer, gridPass, useCache)
{
  ...
  if (oDOM != null)
  {
    ...
    if (json.hasOwnProperty("Callsign"))
    {
      ...
      if (g_appSettings.lookupService == "QRZ")
      {
        json.Callsign.source =
          "<tr><td>"+$.i18n("gt.lookup.Source")+"</td><td><font color='orange'><b><div style='cursor:pointer' onClick='window.opener.openSite(\"https://www.qrz.com/lookup?callsign=" +
          call +
      ...
      {
        json.Callsign.source =
          "<tr><td>"+$.i18n("gt.lookup.Source")+"</td><td><font color='orange'><b><div style='cursor:pointer' onClick='window.opener.openSite(\"https://www.qrzcq.com/call/" +
          call +
    ...
    else
    {
      setLookupDiv(
        "lookupInfoDiv",
        "<br/><b>"+$.i18n("gt.lookup.NoResul")+"</b><br/><br/>"
      );
      g_qrzLookupSessionId = null;
    }
  }
...
function addLookupObjectToIndexedDB(lookupObject)
{
  ...
  {
    addLastTraffic("<font style='color:orange'>"+$.i18n("gt.addLookup.Error")+"</font>");
  };
}
...
function displayLookupObject(lookup, gridPass, fromCache = false)
{
  ...
  worker +=
    "<table title='"+$.i18n("gt.lookup.getAddress")+"' onclick='setClipboardFromLookup();' style='cursor:pointer' >";
  worker += "<tr>";
  ...
  worker += "<tr><th colspan=2>"+$.i18n("gt.lookup.details")+"</th></tr>";
  if (getLookProp(lookup, "url").length > 0)
  {
    worker += "<tr>";
    worker += "<td>"+$.i18n("gt.lookup.website")+"</td>";
    worker += "<td  >";
    worker +=
  ...
  if (dates.length > 0)
  {
    worker += "<tr><td>"+$.i18n("gt.lookup.effectiveDates")+"</td><td>" + dates + "</td></tr>";
  }
  ...
  if (Aliases.length > 0)
  {
    worker +=
      "<tr title='" +
      Aliases +
      "' ><td>"+$.i18n("gt.lookup.aliases")+"</td><td>" +
      Aliases +
      "</td></tr>";
  }
  ...
  {
    worker += "<tr><td>"+$.i18n("gt.Distances")+"</td><td style='color:cyan'>" +
      parseInt(
        MyCircle.distance(
          g_myLat,
          g_myLon,
  ...
  if (g_callsignLookups.lotwUseEnable == true && thisCall in g_lotwCallsigns)
  {
    lookup.ulotw =
      ...
      ")";
    worker += makeRow($.i18n("roster.secondary.exceptions.usesLoTW") , lookup, "ulotw");
  }
  if (g_callsignLookups.eqslUseEnable == true && thisCall in g_eqslCallsigns)
  {
    lookup.ueqsl = "&#10004;";
    worker += makeRow($.i18n("roster.secondary.exceptions.useseQSL") , lookup, "ueqsl");
  }
  if (g_callsignLookups.oqrsUseEnable == true && thisCall in g_oqrsCallsigns)
  {
    lookup.uoqrs = "&#10004;";
    worker += makeRow($.i18n("roster.secondary.exceptions.usesOQRS") , lookup, "uoqrs");
  }

  if (fromCache)
  {
    worker +=
      "<tr><td>"+$.i18n("gt.lookup.cachedRecord") +"</td><td>" +
  ...
  var genMessage =
    "<tr><td colspan=2><div title=\"Clear\" class=\"button\" onclick=\"window.opener.clearLookup();\" >Clear</div> <div title=\""+$.i18n("gt.lookup.genMessages") +"\" class=\"button\" onclick=\"window.opener.setCallAndGrid('" +
    getLookProp(lookup, "call") +
    "','" +
    getLookProp(lookup, "grid") +
    "');\">"+$.i18n("gt.lookup.genMessages") +"</div></td></tr>";
...
function makeYesNoRow(first, object, key)
{
  ...
  if (value.length > 0)
  {
    ...
    if (test == "Y") return "<tr><td>" + first + "</td><td>"+$.i18n("gt.makeYesNo.yes") +"</td></tr>";
    if (test == "N") return "<tr><td>" + first + "</td><td>"+$.i18n("gt.makeYesNo.no") +"</td></tr>";
    if (test == "?") return "";
    return (
      "<tr><td>" +
      first +
  ...
  if (value.length > 0)
  {
    if (clip)
    {
      return (
        "<tr><td>" +
        first +
        "</td><td title='"+$.i18n("gt.lookup.getAddress") +"' style='cursor:pointer;color:cyan;font-weight: bold;' onClick='addTextToClipboard(\"" +
...
function searchLogForCallsign(call)
{
  ...
  {
    worker = `<h3>$.i18n("gt.lookup.acks") ${call}: ` +
  ...
  if (list.length > 0)
  {
    ...
    {
      worker += "<tr><th style='color:yellow'>"+$.i18n("gt.logbook.worked")+"</th><td>";
    ...
    {
      worker += "<tr><th style='color:lightgreen'>"+$.i18n("gt.logbook.confirmed")+"</th><td>";
    ...
    if (lastRow)
    {
      worker += "<tr><th style='color:cyan'>"+$.i18n("gt.logbook.lastContact")+"</th><td>";
      worker +=
        "<font color='#" +
...
function mediaCheck()
{
  ...
  {
    alert(
      $.i18n("gt.documents.error1") + tryDirectory + $.i18n("gt.documents.error2")
    );
    nw.App.quit();
  }
...
function pskSpotCheck(timeSec)
{
  ...
  )
  {
    ...
    spotRefreshDiv.innerHTML = $.i18n("gt.spots.refreshing");
    getBuffer(
  ...
  else if (g_spotsEnabled == 1)
  {
    ...
    {
      spotRefreshDiv.innerHTML = $.i18n("gt.spots.noTX");
    }
    else
    {
      spotRefreshDiv.innerHTML =
        $.i18n("gt.spots.refresh") +
...
function changeSpotValues()
{
  ...
  spotHistoryTimeTd.innerHTML = $.i18n("gt.spots.maxAge") + Number(g_receptionSettings.viewHistoryTimeSec).toDHM();
...
function toggleCRScript()
{
  ...
  {
    addLastTraffic(
      "<font style='color:lightgreen'>"+$.i18n("gt.crScript.enabled") +"</font>"
    );
  }
  else
  {
    addLastTraffic(
      "<font style='color:yellow'>"+$.i18n("gt.crScript.disabled") +"</font>"
    );
  }
  goProcessRoster();
}
